...
const std::array<SVC::FunctionDef, 180> SVC::SVC_Table{{
    ...
    {0x93, &SVC::Wrap<&SVC::InvalidateInstructionCacheRange>, "InvalidateInstructionCacheRange", 1000},
    {0x94, &SVC::Wrap<&SVC::InvalidateEntireInstructionCache>, "InvalidateEntireInstructionCache", 1000},
